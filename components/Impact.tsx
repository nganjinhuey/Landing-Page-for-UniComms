...
const Impact: React.FC = () => {
  return (
    ...
    >
      ...
      {/* "Think About It" Impact Card - Separated for Visual Pop */}
      <div className="max-w-3xl mx-auto mt-8">
        <div className="bg-white rounded-2xl p-6 md:p-8 shadow-xl border border-blue-100 flex flex-col md:flex-row items-center justify-center gap-6 md:gap-8 transform hover:scale-[1.02] transition-transform duration-300">

          {/* Visual Impact Image */}
          <div className="relative shrink-0">
            <div className="w-24 h-24 bg-brand-surface-blue rounded-full flex items-center justify-center overflow-hidden border border-blue-100">
              <img
                src="image32.jpg"
                alt="Teh Tarik Comparison"
          ...
          <div className="text-center md:text-left">
            ...
            <p className="text-slate-600 text-lg leading-relaxed">
              ...
              Cheaper than a Teh Tarik for <span className="font-bold text-brand-teal bg-teal-50 px-2 py-0.5 rounded-lg border border-teal-100 whitespace-nowrap">RM1 Million</span> coverage.
            </p>
          </div>
