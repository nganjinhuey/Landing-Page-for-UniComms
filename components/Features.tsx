...
const Features: React.FC = () => {
    ...
    return (
        <div className="overflow-hidden bg-white">
            ...
            {/* Intro / Who We Are Section - Soft Brand Tint */}
            <section className="py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-brand-surface-blue via-slate-50 to-blue-50/50 rounded-3xl my-8 mx-4 md:mx-auto relative overflow-hidden">
                ...
                <div className="flex flex-col lg:flex-row items-center gap-16 relative z-10">
                    ...
                    <div className="w-full lg:w-1/2 relative">
                        <div className="rounded-3xl overflow-hidden shadow-2xl relative border-4 border-white/50 bg-slate-200 group">
                            <img
                                src="image2.jpg?v=3"
                                alt="We Kongsi Community"
                                className="w-full h-auto object-contain md:group-hover:scale-105 transition-transform duration-700 bg-slate-200"
