...
const Features: React.FC = () => {
    ...
    return (
        <div className="overflow-hidden bg-white">
            ...
            {/* Intro / Who We Are Section - Revert to Light Blue */}
            <section className="py-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 bg-cyan-50 rounded-3xl mt-0 mb-10 mx-4 md:mx-auto relative overflow-hidden">
                {/* Minimal Background */}
